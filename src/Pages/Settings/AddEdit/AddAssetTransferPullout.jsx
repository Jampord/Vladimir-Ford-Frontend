...
const AddAssetTransferPullout = ({ data, onUpdateResetHandler }) => {
  ...
  console.log("watch", watch("approver_id"));
  ...
  const onSubmitHandler = (formData) => {
    ...
    postAssetTransferPullout(newFormData);
  };
...
export default AddAssetTransferPullout;
