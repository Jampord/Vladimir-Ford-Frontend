...
const AddAdditionalCostApprovers = ({ data, onUpdateResetHandler }) => {
  ...
  const onSubmitHandler = (formData) => {
    ...
    postAdditionalCostApprovers(newFormData);
  };
...
export default AddAdditionalCostApprovers;
