...
const ApprovedDisposal = () => {
  ...
  return (
    <Stack className="category_height">
      ...
      {approvalError && <ErrorFetching refetch={refetch} category={approvedDisposalData} error={errorData} />}
      {approvedDisposalData && !approvalError && (
        <Box className="mcontainer__wrapper">
          ...
          <Box>
            <TableContainer className="mcontainer__th-body-category">
              <Table className="mcontainer__table" stickyHeader>
                ...
                <TableBody>
                  {approvedDisposalData?.data.length === 0 ? (
                    <NoRecordsFound heightData="small" />
                  ) : (
                    <>
                      {approvalSuccess &&
                        approvedDisposalData?.data.map((data) => (
                          <TableRow
                            key={data?.id}
                            hover={true}
                            sx={{
          ...
          <CustomTablePagination
            total={approvedDisposalData?.total}
            success={approvalSuccess}
            current_page={approvedDisposalData?.current_page}
            per_page={approvedDisposalData?.per_page}
...
export default ApprovedDisposal;
